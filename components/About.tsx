  ...
  return (
    <div id="about" className="py-10 mt-32 flex flex-col items-center">
      ...
      <div className="relative flex flex-col items-center mt-10">
        <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white relative transition-transform duration-500 ease-in-out hover:scale-110 hover:rotate-3">
          <Image
            src="/emma.png"
            alt="Headshot"
            layout="fill"
